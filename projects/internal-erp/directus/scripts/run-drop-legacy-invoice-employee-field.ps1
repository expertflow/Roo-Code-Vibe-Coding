...
<#
.SYNOPSIS
  Run docs/sql/drop-legacy-invoice-employee-field.sql as break-glass bs4_dev.
...
$sql = Join-Path $root 'docs\sql\drop-legacy-invoice-employee-field.sql'
...
Options:
  ...
  • Run the SQL manually in DBeaver / Cloud SQL Studio as bs4_dev:
      docs/sql/drop-legacy-invoice-employee-field.sql
'@
}
